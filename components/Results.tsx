      ...
      <section id="results-section" className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div
              className={`absolute top-1/2 left-0 h-0.5 bg-gradient-to-r from-primary-blue-light to-primary-blue-dark transform -translate-y-1/2 hidden md:block transition-all duration-1000 ${animated ? 'w-full' : 'w-0'
                }`}
            />
            ...
            <div className="grid md:grid-cols-2 gap-12 relative">
              {milestones.map((milestone, index) => (
                <div
                  key={index}
                  className={`bg-white rounded-2xl p-8 border-2 border-primary-blue/40 shadow-lg hover:shadow-2xl hover:border-primary-blue transition-all animate-fade-in-up ${animated ? 'opacity-100' : 'opacity-0'
                    }`}
                  style={{
                ...
                >
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-white border-2 border-primary-blue rounded-full flex items-center justify-center text-primary-dark font-bold text-xl mr-4 shadow-lg">
                      {index + 1}
                    </div>
                    <div>
