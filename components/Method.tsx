      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary-dark to-primary-dark-light">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-4">
            <span className="text-primary-green-bright drop-shadow-[0_0_10px_rgba(34,197,94,0.5)]">Sistema de Alavancagem de Carreira</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-gradient-to-br from-primary-green-light/20 to-primary-green-dark/20 backdrop-blur-sm rounded-xl p-6 border-2 border-primary-green/50 shadow-[0_0_20px_rgba(34,197,94,0.3)]">
              <div className="text-5xl font-bold text-primary-green-bright mb-3 drop-shadow-[0_0_10px_rgba(34,197,94,0.6)]">1</div>
            ...
            <div className="bg-gradient-to-br from-primary-green-light/20 to-primary-green-dark/20 backdrop-blur-sm rounded-xl p-6 border-2 border-primary-green/50 shadow-[0_0_20px_rgba(34,197,94,0.3)]">
              <div className="text-5xl font-bold text-primary-green-bright mb-3 drop-shadow-[0_0_10px_rgba(34,197,94,0.6)]">2</div>
            ...
            <div className="bg-gradient-to-br from-primary-green-light/20 to-primary-green-dark/20 backdrop-blur-sm rounded-xl p-6 border-2 border-primary-green/50 shadow-[0_0_20px_rgba(34,197,94,0.3)]">
              <div className="text-5xl font-bold text-primary-green-bright mb-3 drop-shadow-[0_0_10px_rgba(34,197,94,0.6)]">3</div>
